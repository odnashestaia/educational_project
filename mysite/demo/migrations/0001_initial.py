    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emain', models.CharField(max_length=254, unique=True, verbose_name='Почта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('role', models.CharField(choices=[('new', 'Новые'), ('exsept', 'Принятые'), ('cancelled', 'Отменные')], default='exsept', max_length=254, verbose_name='Статус')),
                ('reason', models.CharField(max_length=1000, verbose_name='Причина отказа')),
                ('products', models.ManyToManyField(related_name='orders', through='demo.Goods', to='demo.product')),
        ...
        migrations.AddField(
            model_name='goods',
            name='orders',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demo.orders', verbose_name='Заказы'),
        ),
        migrations.AddField(
            model_name='goods',
            name='product',
